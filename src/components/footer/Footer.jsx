...
const Footer = () => {
  return (
    <div className=' mt-10 bg-blue-500 flex justify-center pb-10 text-white'>
      <div className=' w-full max-w-[1200px]  my-grid2 '>
        <div className='flex flex-col gap-4 '>
          ...
          <div className=' flex items-center gap-2 text-lg font-semibold'>
            <Phone />
            <h1 className=' text-lg font-thin'>07xxxxxxxx</h1>
          </div>
          <div className=' flex items-center gap-2 text-lg font-semibold'>
            <Email />
            <h1 className=' text-lg font-thin'>abc@gmail.com</h1>
          </div>
          ...
          <div className=' flex gap-1 items-center'>
            ...
            <button className=' bg-blue-950 text-white p-2 px-6 rounded-r-lg'>
              Subscribe
            </button>
          </div>
        </div>
